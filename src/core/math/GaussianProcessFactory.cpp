...
DEFINE_STRINGABLE_ENUM(CovarianceFunctionFactory, "covariance", ({
    {"svls_squared_exponential", std::make_shared<SVLengthScaleSquaredExponentialCovariance>},
...
DEFINE_STRINGABLE_ENUM(ConvolutionFunctionFactory, "convolution", ({
    {"squared_exponential", std::make_shared<SquaredExponentialConvolution>},
    {"svsl_squared_exponential", std::make_shared<SVLengthScaleSquaredExponentialConvolution>}
    }))
