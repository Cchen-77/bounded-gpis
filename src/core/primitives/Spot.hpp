...
namespace Tungsten {
    ...
    class Spot : public Primitive
    {
        ...
        float _spotInnerAngleDeg;
        float _spotOuterAngleDeg;

        Vec3f _spotDirection;
        TangentFrame _spotFrame;

        float _spotInnerAngleRad;
        float _spotOuterAngleRad;

        float _cosInnerAngle;
        float _costOuterAngle;
